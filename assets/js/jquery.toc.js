 ...
 */
(function($) {
    var toggleHTML = '<div id="toctitle">' +
    '<span class="toctoggle"><a id="toctogglelink" class="internal" href="#">%2</a></span>  <h2>%1</h2>' +
    '</div>';
    var tocContainerHTML = '<div id="toc-container">' +
    ...
    $.fn.toc = function(settings) {
        ...
        if (show && tocHTML) {
            ...
            if (config.saveShowStatus && $.cookie('toc-hide')) {
                ...
                ul.hide();
                $('#toctogglelink').html(config.showText);
                $('#toc').addClass('tochidden');
            }
